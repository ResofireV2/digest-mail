  ...
  view:function(){
    ...
    return m("div",null,
      m("div",{className:"ExtensionPage-settings"},m("div",{style:"max-width:600px;margin:0 auto;"},
        ...
        m(SelectSetting, {settingKey:"resofire-digest-mail.picks_leaderboard_scope",options:{"alltime":tr("resofire-digest-mail.admin.settings.picks_leaderboard_scope_alltime"),"season":tr("resofire-digest-mail.admin.settings.picks_leaderboard_scope_season"),"week":tr("resofire-digest-mail.admin.settings.picks_leaderboard_scope_week")},label:tr("resofire-digest-mail.admin.settings.picks_leaderboard_scope_label"),help:tr("resofire-digest-mail.admin.settings.picks_leaderboard_scope_help")}),
