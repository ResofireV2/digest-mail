...
var TestSendSection={
  ...
  view:function(vnode){
    var state=vnode.state;var exts=(app().forum.attribute("digestExtensions"))||{};var nightmodeEnabled=(exts.nightmode||{}).enabled||false;var cosmosThemeEnabled=(exts["cosmos-theme"]||{}).enabled||false;var themePickerEnabled=nightmodeEnabled||cosmosThemeEnabled;var tr=function(k,v){return app().translator.trans(k,v);};
    if(!themePickerEnabled&&state.theme==="dark"){state.theme="light";}
